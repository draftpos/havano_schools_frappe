frappe.ui.form.on("Test Schedule", {
    refresh(frm) {
...
function filter_subject_by_teacher(frm) {
    frappe.call({
        method: "school.school_management.doctype.test_schedule.test_schedule.get_teacher_subjects",
        args: {
...
function fetch_students(frm) {
    frm.clear_table("test_items");
    frm.refresh_field("test_items");
    frappe.call({
        method: "school.school_management.doctype.test_schedule.test_schedule.get_students",
        args: {
            student_class: frm.doc.student_class,
        ...
        callback: function(r) {
            if (r.message && r.message.length > 0) {
                r.message.forEach(function(student) {
                    let row = frm.add_child("test_items");
